$(function () {
    ...
    function adjustHeader()
    {
        ...
        var domain = parsed.hostname.split('.').slice(-5).join('.')
        ...
        if(windowWidth > 0) {
            if ($(document).scrollTop() >= 100) {
                ...
                if($('.do-sticky').length < 1) {
                    $('.company-logo img').attr('src', 'http://' + domain + ':8000' + '/static/img/logos/black-logo.png');
                }
            }
            else {
                $('.sticky-header').removeClass('header-shrink');
                if($('.do-sticky').length < 1 && $('.fixed-header').length == 0 && $('.fixed-header2').length == 0) {
                    $('.company-logo img').attr('src', 'http://' + domain + ':8000' + '/static/img/logos/logo.png');
                } else {
                    $('.company-logo img').attr('src', 'http://' + domain + ':8000' + '/static/img/logos/black-logo.png');
                }
            }
